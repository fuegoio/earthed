...
- API client: `@planetary/api-client` (in `packages/api-client/`), generated from the OpenAPI spec via `@hey-api/openapi-ts`. Types come from `go/api/openapi.json`. Regenerate with `pnpm --filter @planetary/api-client gen`.
