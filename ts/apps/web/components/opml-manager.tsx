  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-6 sm:px-6">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Import or export your feed subscriptions as an OPML file. OPML is the
        standard format for sharing RSS subscriptions between readers.
      </p>
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="flex items-center justify-between rounded-lg border border-border p-4">
          <div>
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">
              Upload an OPML file to subscribe to all feeds. Categories are
              created automatically. Existing subscriptions are skipped.
            </p>
          </div>
          <Button
            variant="outline"
