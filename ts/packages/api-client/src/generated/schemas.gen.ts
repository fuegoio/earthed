...
export const APITokenSchema = {
  ...
  required: ["id", "user_id", "label", "created_at", "last_used_at"],
  type: "object",
} as const;
...
export const EnclosureSchema = {
  ...
  required: ["id", "entry_id", "url", "mime_type", "size"],
  type: "object",
} as const;
...
export const FeedListSchema = {
  ...
  required: ["id", "user_id", "title", "is_public", "feed_count", "created_at", "updated_at"],
  type: "object",
} as const;
...
export const FeedListFeedSchema = {
  ...
  required: ["id", "feed_list_id", "feed_url", "site_url", "title", "position"],
  type: "object",
} as const;
...
export const FolderSchema = {
  ...
  required: ["id", "user_id", "title", "sort_order", "created_at", "updated_at"],
  type: "object",
} as const;
...
export const Import_feed_listResponseSchema = {
  ...
  required: ["imported", "skipped", "failed", "feed_ids"],
  type: "object",
} as const;
...
export const PreviewFeedBodySchema = {
  ...
  required: ["title", "site_url", "feed_url", "items"],
  type: "object",
} as const;
...
export const TokenOutputBodySchema = {
  ...
  required: ["id", "label", "token", "created_at"],
  type: "object",
} as const;
